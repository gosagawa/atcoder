...
func main() {
	...
	o := 0
	cb := newcombFactorial(500*500 + 10)
	n := ni()
	n2 := n * n
	o = cb.factorial(n2)
	for i := 1; i <= n2; i++ {
		...
		t1 := mmul(cb.combination(i-1, n-1), cb.factorial(n-1))
		t2 := mmul(cb.combination(n2-i, n-1), cb.factorial(n-1))
		t := mmul(n2, mmul(t1, t2))
		//out(i, i-1, n2-i, n2-2*n+1, t1, t2)
		t = mmul(t, cb.factorial(n2-2*n+1))
		o = madd(o, -t)
	}
	out(o)
}
