...
func solve() {
	...
	rhsla1 := newrhsl(as, mod)
	rhsla1.setSearchBase(0, 0)
	rhsla2 := newrhsl(as, mod)
	rhsla2.setSearchBase(0, n)
	rhslb1 := newrhsl(bs, mod)
	rhslb1.setSearchBase(0, n)
	rhslb2 := newrhsl(bs, mod)
	rhslb2.setSearchBase(n, n)
	for i := 0; i < n; i++ {
		a1 := rhsla1.chash
		a2 := rhsla2.chash
		b1 := rhslb1.chash
