		...
		for a1 := 1; a1 <= m+1; a1++ {
			for a2 := 1; a2 <= m+1; a2++ {
				for a3 := 1; a3 <= m+1; a3++ {
					for x := 1; x <= m; x++ {
						if x <= a1 {
							dp[i+1][x][a2][a3] = madd(dp[i+1][x][a2][a3], dp[i][a1][a2][a3])
						} else if x <= a2 {
							dp[i+1][a1][x][a3] = madd(dp[i+1][a1][x][a3], dp[i][a1][a2][a3])
						} else if x <= a3 {
							dp[i+1][a1][a2][x] = madd(dp[i+1][a1][a2][x], dp[i][a1][a2][a3])
						}
