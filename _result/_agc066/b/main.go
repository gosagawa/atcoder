...
func main() {
	...
	//out(findans())
	r := ""
	out(r)
	return
	...
	// 543 609 669 726 777 816 867 924 984 1050 1101 1140 1200 1275 1353 1419 1497 1545 1587 1617 1668 1734 1803 1860 1902 1959 2010 2049 2091 2103 2118 2121 2145 2148 2190 2247 2316 2364 2397 2445 2487 2544 2595 2607 2649 2679 2739 2778 2838 2904
...
func findans() string {
	...
	for k := 0; k < 9; k++ {
		...
		for i := 0; i < 80; i++ {
			...
			if k == 2 && i >= 47 && i <= 64 {
				ts2 := make([]string, len(ts[k]))
				for l, v := range ts[k] {
					ts2[len(ts[k])-l-1] = itoa(v)
				}
				r += sj(ts2)
			}
		}
