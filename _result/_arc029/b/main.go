...
func main() {
	...
	check := func(a, b, c, d float64) bool {
		...
		debug(a, b, c, d, e)
		debug(er, er/math.Pi*180)
		debug(abr, abr/math.Pi*180)
		r1 := er - abr
		r2 := math.Pi/2 - (er - abr)
		debug(r1, r1/math.Pi*180)
		debug(r2, r2/math.Pi*180)
		//		debug(math.Asin(1.0) / math.Pi * 180)
		//		debug(math.Asin(0.5) / math.Pi * 180)
		nc := 0.0
		nc += math.Cos(r1) * b
		nc += math.Cos(r2) * a
		debug(nc)
