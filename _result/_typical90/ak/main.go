...
var stcadd streeculctype = 1
var stcset streeculctype = 2
var stcmax streeculctype = 3
...
/*
s := newstree(n,stmin|stmax,stcset|stcadd|stcmax)
s.set(i,x)
s.add(i,x)
s.rc(l,r,x)
result1 := s.query(l,r)
...
func (s *stree) get(i int) int {
	return s.querysub(i, i+1, 0, 0, s.n)
}
