...
func main() {
	...
	for qi := 0; qi < q; qi++ {
		...
		case 1:
			...
			set1.Increment(x)
			keyl, hasKeyl := set1.LowerBound(x)
			keyu, hasKeyu := set1.UpperBound(x)
			if hasKeyl && hasKeyu {
				set2.Decrement(keyl ^ keyu)
				set2.Increment(keyl ^ x)
				set2.Increment(x ^ keyu)
			} else if hasKeyl {
				set2.Increment(keyl ^ x)
			} else if hasKeyu {
				set2.Increment(x ^ keyu)
		...
		case 2:
			...
			keyu, hasKeyu := set1.UpperBound(x)
			if hasKeyl && hasKeyu {
				set2.Increment(keyl ^ keyu)
				set2.Decrement(keyl ^ x)
				set2.Decrement(x ^ keyu)
			} else if hasKeyl {
				set2.Decrement(keyl ^ x)
			} else if hasKeyu {
				set2.Decrement(x ^ keyu)
