...
func main() {
	...
	for i := 0; i < n; i++ {
		for j := 0; j < 5; j++ {
			...
			switch j {
			case 0:
				dp[i+1][0] = min(dp[i+1][0], dp[i][0]+ns[i])
			case 1:
				dp[i+1][1] = min(dp[i+1][1], dp[i][0]+ns[i])
				dp[i+1][1] = min(dp[i+1][1], dp[i][1]+max(sub, ns[i]%2))
			case 2:
				dp[i+1][2] = min(dp[i+1][2], dp[i][0]+ns[i])
				dp[i+1][2] = min(dp[i+1][2], dp[i][1]+max(sub, ns[i]%2))
				dp[i+1][2] = min(dp[i+1][2], dp[i][2]+(ns[i]+1)%2)
			case 3:
				dp[i+1][3] = min(dp[i+1][3], dp[i][0]+ns[i])
				dp[i+1][3] = min(dp[i+1][3], dp[i][1]+max(sub, ns[i]%2))
				dp[i+1][3] = min(dp[i+1][3], dp[i][2]+(ns[i]+1)%2)
				dp[i+1][3] = min(dp[i+1][3], dp[i][3]+max(sub, ns[i]%2))
			case 4:
				dp[i+1][4] = min(dp[i+1][4], dp[i][0]+ns[i])
				dp[i+1][4] = min(dp[i+1][4], dp[i][1]+max(sub, ns[i]%2))
				dp[i+1][4] = min(dp[i+1][4], dp[i][2]+(ns[i]+1)%2)
				dp[i+1][4] = min(dp[i+1][4], dp[i][3]+max(sub, ns[i]%2))
				dp[i+1][4] = min(dp[i+1][4], dp[i][4]+ns[i])
			}
		}
	}
	debugi2s(dp)
