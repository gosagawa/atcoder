...
func main() {
	...
	for i := 0; i < n; i++ {
		...
		ts[ss[0]][ss[1]][ss[2]][ss[3]][ss[4]][ss[5]] += v
	}
	for k := 0; k < 6; k++ {
		for v1 := 1; v1 <= 10; v1++ {
			for v2 := 1; v2 <= 10; v2++ {
				for v3 := 1; v3 <= 10; v3++ {
					for v4 := 1; v4 <= 10; v4++ {
						for v5 := 1; v5 <= 10; v5++ {
							for v6 := 1; v6 <= 10; v6++ {
								if k == 0 {
									ts[v1][v2][v3][v4][v5][v6] += ts[v1-1][v2][v3][v4][v5][v6]
								}
								if k == 1 {

									ts[v1][v2][v3][v4][v5][v6] += ts[v1][v2-1][v3][v4][v5][v6]
								}
								if k == 2 {

									ts[v1][v2][v3][v4][v5][v6] += ts[v1][v2][v3-1][v4][v5][v6]
								}
								if k == 3 {

									ts[v1][v2][v3][v4][v5][v6] += ts[v1][v2][v3][v4-1][v5][v6]
								}
								if k == 4 {

									ts[v1][v2][v3][v4][v5][v6] += ts[v1][v2][v3][v4][v5-1][v6]
								}
								if k == 5 {

									ts[v1][v2][v3][v4][v5][v6] += ts[v1][v2][v3][v4][v5][v6-1]
								}
							}
						}
					}
	...
	for i := 0; i < q; i++ {
		...
		for j := 0; j < pow2(6); j++ {
			...
			if pcs[j] == 0 {
				o += ts[ts2[0]][ts2[1]][ts2[2]][ts2[3]][ts2[4]][ts2[5]]
			} else {
				o -= ts[ts2[0]][ts2[1]][ts2[2]][ts2[3]][ts2[4]][ts2[5]]
			}
		}
