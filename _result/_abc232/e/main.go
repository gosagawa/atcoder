...
func main() {
	...
	dp[0][st] = 1
	for i := 0; i < k; i++ {
		dp[i+1][0] = madd(dp[i+1][0], mmul(dp[i][0], (h-2+w-2)))
		dp[i+1][1] = madd(dp[i+1][1], mmul(dp[i][0], 1))
		dp[i+1][2] = madd(dp[i+1][2], mmul(dp[i][0], 1))
		dp[i+1][1] = madd(dp[i+1][1], mmul(dp[i][1], (w-2)))
		dp[i+1][0] = madd(dp[i+1][0], mmul(dp[i][1], (h-1)))
		dp[i+1][2] = madd(dp[i+1][2], mmul(dp[i][2], (h-2)))
		dp[i+1][0] = madd(dp[i+1][0], mmul(dp[i][2], (w-1)))
		dp[i+1][3] = madd(dp[i+1][3], mmul(dp[i][1], 1))
		dp[i+1][3] = madd(dp[i+1][3], mmul(dp[i][2], 1))
		dp[i+1][1] = madd(dp[i+1][1], mmul(dp[i][3], (w-1)))
		dp[i+1][2] = madd(dp[i+1][2], mmul(dp[i][3], (h-1)))
	}
	out(dp[k][3])
