...
func main() {
	...
	mins(&o, abs(as[0]-as[1])+abs(as[1]-as[2]))
	mins(&o, abs(as[0]-as[2])+abs(as[2]-as[1]))
	mins(&o, abs(as[1]-as[2])+abs(as[2]-as[0]))
	mins(&o, abs(as[1]-as[0])+abs(as[0]-as[2]))
	mins(&o, abs(as[2]-as[0])+abs(as[0]-as[1]))
	mins(&o, abs(as[2]-as[1])+abs(as[1]-as[0]))
