...
func main() {
	...
	if x >= y {
		...
		o = float64(d-s) / float64(x+y)
	} else {
		if d > s {
			dbg(float64(d-s)/float64(x+y), float64(l-d+s)/float64(y-x))
			o = minf(float64(d-s)/float64(x+y), float64(l-d+s)/float64(y-x))
		} else {
			dbg(float64(s-d)/float64(y-x), float64(l-s+d)/float64(x+y))
			o = minf(float64(s-d)/float64(y-x), float64(l-s+d)/float64(x+y))
		}
	}
