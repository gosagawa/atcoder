...
func main() {
	...
	mp := make(map[string][2]int)
	mp["S"] = [2]int{16875, 19125}
	mp["NNE"] = [2]int{1125, 3375}
	mp["SSW"] = [2]int{19125, 21375}
	mp["NE"] = [2]int{3375, 5625}
	mp["SW"] = [2]int{21375, 23625}
	mp["ENE"] = [2]int{5625, 7875}
	mp["WSW"] = [2]int{23625, 25875}
	mp["E"] = [2]int{7875, 10125}
	mp["W"] = [2]int{25875, 28125}
	mp["ESE"] = [2]int{10125, 12375}
	mp["WNW"] = [2]int{28125, 30375}
	mp["SE"] = [2]int{12375, 14625}
	mp["NW"] = [2]int{30375, 32625}
	mp["SSE"] = [2]int{14625, 16875}
	mp["NNW"] = [2]int{32625, 34875}

	mp2 := make(map[int][2]int)
	mp2[0] = [2]int{0, 2}
	mp2[1] = [2]int{3, 15}
	mp2[2] = [2]int{16, 33}
	mp2[3] = [2]int{34, 54}
	...
	mp2[8] = [2]int{172, 207}
	mp2[9] = [2]int{208, 244}
	mp2[10] = [2]int{245, 284}
	mp2[11] = [2]int{285, 326}
	mp2[12] = [2]int{327, inf}
	...
	ws := int(math.Round(float64(w) / 60 * 10))
	vn := 0
	for i, v := range mp2 {
		if v[0] <= ws && ws <= v[1] {
			vn = i
