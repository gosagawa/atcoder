...
func main() {
	...
	dbg(uf.issame(k, k+1))
	dbg(uf.issame(k+2, k+3))
	dbg(uf.issame(k, k+2))
	dbg(uf.issame(k+1, k+3))

	if uf.issame(k, k+1) || uf.issame(k+2, k+3) || uf.issame(k, k+2) || uf.issame(k+1, k+3) {
		out("No")
		return
	}
	out("Yes")
