...
func main() {
	...
	debug(ts2)
	o = ts2[0]
	var dfs2 func(v, p, v1, v2 int)
	dfs2 = func(v, p, v1, v2 int) {
		debug(v, p, v1, v2, v2+ts2[v])
		mins(&o, v2+ts2[v])
		...
		for _, nv := range edges[v] {
			...
			nv1 := v1 + ts[v] - ts[nv.to]
			nv2 := v2 + ts2[v] - (ts2[nv.to] + ts[nv.to]) + nv1
			dfs2(nv.to, v, nv1, nv2)
		}
	}
	dfs2(0, -1, 0, 0)
